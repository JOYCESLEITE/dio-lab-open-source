...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout -b feat/community/JOYCESLEITE`;
    > Exemplo: `git checkout -b feat/community/JOYCESLEITE`
...
7. Adicione suas alterações a "staging area" com o comando `git add community/JOYCESLEITE.md`;
